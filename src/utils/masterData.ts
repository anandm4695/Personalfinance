...
export const DEFAULT_MASTER_DATA: MasterData = {
  ...
  ccTransactionCategories: [
    ...
    "Entertainment", "Medical", "Utilities", "Travel", "Payment", "Other",
  ],
  prepaidCategories: [
    "Food", "Groceries", "Transport", "Shopping",
    "Entertainment", "Medical", "Utilities", "Other",
  ],
  goalCategories: [
    "Wealth", "Retirement", "Home", "Vehicle", "Education",
    "Travel", "Emergency Fund", "Wedding", "Other",
  ],
  mfCategories: [
    "Equity", "Debt", "Hybrid", "ELSS", "Index", "Liquid", "International",
  ],
  bankAccountTypes: ["Savings", "Current", "Salary", "Joint"],
  loanTypes: ["Personal", "Home", "Car", "Education", "Gold", "Business", "Other"],
  prepaidCardTypes: [
    "Meal Card", "Digital Wallet", "Travel Card", "Prepaid Card", "Gift Card", "Fuel Card",
  ],
